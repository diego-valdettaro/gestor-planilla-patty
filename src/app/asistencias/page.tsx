...
export default async function PaginaDeAsistencias({ searchParams }: PropiedadesDePagina) {
  ...
  if (actor.rol !== "administracion" && actor.rol !== "finanzas") return <main className="centrado"><section className="estado-vacio"><h1>Sin permiso</h1><p>Su rol no permite revisar asistencias. Solo Administración y Finanzas pueden hacerlo.</p></section></main>;
