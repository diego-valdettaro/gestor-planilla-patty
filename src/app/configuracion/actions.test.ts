...
vi.mock("@/turnos/configurar-equipos-operativos", () => ({ asignarEquipoOperativo: simulacro.asignar }));
...
describe("asignar grupo de una sede desde Configuración", () => {
  ...
  it("devuelve el error sin descartar el estado del formulario", async () => {
    ...
    await expect(asignarEquipoOperativoASede({}, formulario({ nombre: "Tienda Centro", equipoOperativo: "taller" })))
